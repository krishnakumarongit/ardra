...
class Invoice extends MY_Controller {
	...
	{
		parent::__construct();
		$this->invoice_menu = 'active';
		$this->invoice_add_menu = ''; 
		$this->invoice_list_menu = '';
		
	}

	public function add($id = 0)
	{
		$this->invoice_add_menu = 'active'; 
		...
		$meta_title .= ' '.$this->lang->line('invoice');
		$dynamic_js = "";
		$view = $this->load->view('invoice_add',['data' => $data,'memberships' => $memberships,'members' => $members ,'id' => $id],true);
