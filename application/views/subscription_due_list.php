<section class="content-header">
  <h1>
	<?php echo $this->lang->line('due'); ?> <?php echo $this->lang->line('payments'); ?>
  ...
  <ol class="breadcrumb">
	...
	<li class="active"><?php echo $this->lang->line('due'); ?> <?php echo $this->lang->line('payments'); ?></li>
  </ol>
</section>
...
<!-- -->
<form method="get" action="<?php echo site_url('list-due-payment'); ?>" autocomplete="off">
<div class="box box-default">
        ...
        <div class="box-footer" style="">
         <a href="<?php echo site_url('list-due-payment'); ?>"><button type="button" class="btn btn-default"><i class="fa fa-times-circle"></i> <?php echo $this->lang->line('clear'); ?></button></a>
            ...
            <div class="box-body">
              ...
              <table class="table table-bordered ">
                ...
                <tr>
                  ...
                  <td>
                    <?php echo date('M d, Y',strtotime($row->next_payment)); ?>
                  </td>
                  <td style="text-align:center;">				
					  <a href="<?php echo site_url('add-due-payment/'.$row->id); ?>">
					 <button type="submit" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('payment'); ?></button>
                </button></a>
